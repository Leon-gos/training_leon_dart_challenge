              ...
              child: Center(
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.all(Radius.circular(state.borderRadius.value)),
                      ...
                      Row(
                        children: [
                          ...
                          DropdownButton(
                            ...
                            items: const [
                              DropdownMenuItem(value: BorderRadiusType.borderNone, child: Text("none")),
                              DropdownMenuItem(value: BorderRadiusType.border8, child: Text("border8")),
                              DropdownMenuItem(value: BorderRadiusType.border16, child: Text("border16")),
                              DropdownMenuItem(value: BorderRadiusType.border32, child: Text("border32")),
                            ],
                          )
                        ],
                      ),
                        ...
                        children: [
                          ...
                          DropdownButton(
                            ...
                            items: const [
                              ...
                              DropdownMenuItem(value: BlendMode.colorBurn, child: Text("colorBurn")),
                              DropdownMenuItem(value: BlendMode.colorDodge, child: Text("colorDodge")),
                              ...
                              DropdownMenuItem(value: BlendMode.exclusion, child: Text("exclusion")),
                              DropdownMenuItem(value: BlendMode.hardLight, child: Text("hardLight")),
                              DropdownMenuItem(value: BlendMode.hue, child: Text("hue")),
                              DropdownMenuItem(value: BlendMode.lighten, child: Text("lighten")),
                              DropdownMenuItem(value: BlendMode.luminosity, child: Text("luminosity")),
                              DropdownMenuItem(value: BlendMode.modulate, child: Text("modulate")),
                              DropdownMenuItem(value: BlendMode.multiply, child: Text("multiply")),
                              DropdownMenuItem(value: BlendMode.overlay, child: Text("overlay")),
                              DropdownMenuItem(value: BlendMode.plus, child: Text("plus")),
                              DropdownMenuItem(value: BlendMode.saturation, child: Text("saturation")),
                              DropdownMenuItem(value: BlendMode.screen, child: Text("screen")),
                              DropdownMenuItem(value: BlendMode.softLight, child: Text("softLight")),
