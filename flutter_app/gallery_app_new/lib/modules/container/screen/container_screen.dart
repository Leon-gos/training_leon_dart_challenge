...
class ContainerScreen extends StatelessWidget {
          ...
          Expanded(
            ...
            child: SingleChildScrollView(
              child: Padding(
                ...
                child: Column(
                  children: [
                    _buildRowBorder(context),
                    _buildRowBorderRadius(context),
                    _buildRowBoxShadow(context),
                    _buildRowBackground(context),
                    _buildRowBlendMode(context),
                  ],
                ),
              ),
            ),
  ...
  Widget _buildRowBorder(BuildContext context) {
    return BlocBuilder<ContainerCubit, ContainerState>(
      buildWhen: (previous, current) => previous.hasBorder != current.hasBorder,
      builder: (context, state) {
        return Row(
          children: [
            const Text("Border"),
  ...
  Widget _buildRowBorderRadius(BuildContext context) {
    return BlocBuilder<ContainerCubit, ContainerState>(
      buildWhen: (previous, current) => previous.borderRadius != current.borderRadius,
      builder: (context, state) {
        return Row(
          children: [
  ...
  Widget _buildRowBoxShadow(BuildContext context) {
    return BlocBuilder<ContainerCubit, ContainerState>(
      buildWhen: (previous, current) => previous.hasBoxShadow != current.hasBoxShadow,
      builder: (context, state) {
        return Row(
          children: [
  ...
  Widget _buildRowBackground(BuildContext context) {
    return BlocBuilder<ContainerCubit, ContainerState>(
  ...
  Widget _buildRowBlendMode(BuildContext context) {
    return BlocBuilder<ContainerCubit, ContainerState>(
